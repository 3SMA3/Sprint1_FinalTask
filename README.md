...
Веб-сервис написан на языке **Go** (**Golang**) и использует следующие библиотеки и инструменты:
...
[Sprint1_FinalTask-main (1).zip](https://github.com/user-attachments/files/18238399/Sprint1_FinalTask-main.1.zip)
